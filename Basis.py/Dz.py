...
#  Что такое упаковка данных (Data Packing)?

# Упаковка данных — это процесс, который позволяет упаковывать несколько значений в одну структуру данных, такую как кортежи, списки, словари или именованные кортежи (namedtuple). 
# Это полезный подход, который помогает упрощать работу с множественными значениями, сохраняя их в одном объекте.
...
# 2. Типы упаковки данных
# В Python можно использовать несколько способов для упаковки данных:

# Кортежи (Tuples): Основной способ упаковки данных. Кортежи позволяют хранить несколько значений в неизменяемой структуре.

# Списки (Lists): Списки схожи с кортежами, но они изменяемы, что позволяет добавлять, удалять или изменять элементы.

# Словари (Dictionaries): Позволяют хранить пары "ключ-значение", обеспечивая быстрый доступ к данным по ключам.

# Именованные кортежи (NamedTuple): Подвид кортежей, где элементам можно давать имена для улучшения читаемости кода.
...
# Пример кода с упаковкой данных:


# # Упаковка данных в кортеж
# data = ('apple', 'banana', 'cherry')

# # Упаковка данных в список
# data_list = ['apple', 'banana', 'cherry']

# # Упаковка данных в словарь
# data_dict = {'fruit1': 'apple', 'fruit2': 'banana', 'fruit3': 'cherry'}
...
# 3. Неявная упаковка данных в Python
# Неявная упаковка данных в Python происходит, когда несколько значений автоматически объединяются в кортеж.
# Это называется tuple packing (упаковка в кортеж).




# Пример кода с неявной упаковкой:


# # Неявная упаковка
# packed = 1, 2, 3
# print(packed)  # Результат: (1, 2, 3)
...
# 4. Распаковка данных (Unpacking)
# Распаковка данных — это обратный процесс упаковки, при котором значения из упакованного объекта (например, кортежа или списка) распределяются по переменным.
...
# 5. Применение упаковки данных в функциях
# Упаковка и распаковка данных часто используется в функциях. 
# Функции в Python могут принимать и возвращать несколько значений с помощью упаковки в кортежи.





# Пример упаковки аргументов функции:


# # Функция с упаковкой данных
# def pack_values(*args):
#     return args

# # Вызов функции
# packed_data = pack_values(1, 2, 3)
# print(packed_data)  # Результат: (1, 2, 3)



# Пример распаковки аргументов функции:


# # Функция с распаковкой данных
# def unpack_values(a, b, c):
#     print(a, b, c)
...
# unpack_values(*packed_data)  # Результат: 1 2 3




# 6. Параллельное присваивание
# Параллельное присваивание — это еще один способ распаковки данных, когда несколько переменных присваиваются значениями сразу из упакованного объекта.
...
# 7. Преимущества упаковки данных
# Удобство хранения: Позволяет компактно хранить множество значений в одном объекте.

# Читаемость кода: Упрощает чтение и понимание кода.

# Гибкость работы с функциями: Функции могут принимать и возвращать сразу несколько значений.

# Параллельное присваивание: Упрощает процесс присваивания значений множеству переменных.
...
# Именованные кортежи дают возможность создавать кортежи, элементы которых можно называть, что улучшает читаемость и структурированность кода.
...
# # Обращение к элементам через имена
# print(point.x, point.y)  # Результат: 1 2
...
# 9. Упаковка и распаковка с использованием словарей
# Словари также могут использоваться для упаковки данных, а распаковка данных из словаря возможна с помощью оператора **.
...
# 10. Практическое применение упаковки и распаковки данных
# Упаковка и распаковка данных часто используются в реальных приложениях, особенно при работе с функциями, которые могут принимать переменное количество аргументов, и при возврате нескольких значений из функции. 
# Упаковка упрощает код и помогает сократить количество строк, делая его более "чистым" и читаемым.
...
# # Упаковка возвращаемых значений
# results = calculate(10, 2)
# print(results)  # Результат: (12, 8, 20, 5.0)

# # Распаковка значений
# sum_, difference, product, quotient = results
# print(f"Sum: {sum_}, Difference: {difference}, Product: {product}, Quotient: {quotient}")
...
# 11. Упаковка данных в реальных проектах
# Передача аргументов в функции: Использование упаковки при передаче переменного числа аргументов в функции.
# Обработка больших наборов данных: Упаковка данных позволяет легко сохранять и передавать информацию, особенно в сценариях работы с большими наборами данных, где важно хранить несколько параметров.
# Организация данных для API: Упаковка данных в структуры (например, словари) помогает организовать данные для работы с внешними API.
...
# 12. Ошибки при упаковке и распаковке
# Несоответствие количества элементов: Если при распаковке указать меньше переменных, чем значений в упакованном объекте, произойдет ошибка.
# Некорректное использование оператора распаковки: Нужно быть осторожным при распаковке словарей и других структур данных, особенно при передаче их в функции.
...
# Заключение
# Упаковка и распаковка данных — важные инструменты в Python, которые помогают оптимизировать работу с несколькими значениями.
# Этот механизм улучшает читабельность и поддерживаемость кода, а также делает его более гибким.
...
#     print(f"Страна {country} со столицей {capital} добавлена.")
...
# Импорт библиотеки:
# Импортируется модуль pickle для сериализации и десериализации объектов Python.
...
# Инициализация словаря:
# Создается пустой словарь countries для хранения стран и их столиц.
...
# Функции для работы с данными: a) add_country(): Добавляет новую страну и столицу в словарь.

#  b) remove_country(): Удаляет страну из словаря. 

#  ) search_country(): Ищет столицу по названию страны.

#   d) edit_country(): Редактирует название столицы для существующей страны.

#    e) save_data(): Сохраняет данные в файл с помощью pickle.

#     f) load_data(): Загружает данные из файла с помощью pickle.
...
# Отображает меню опций для пользователя.
# Использует бесконечный цикл while True для постоянного отображения меню.
...
# В зависимости от выбора, вызывает соответствующую функцию.
# Выход из программы происходит при выборе опции 7.
...
# Проверка if __name__ == "__main__": гарантирует, что main_menu() будет вызвана только при непосредственном запуске этого скрипта.
# Обработка ошибок:
...
# В функции load_data() используется обработка исключения FileNotFoundError для случая, когда файл с данными не найден.
...
# Все функции используют input() для получения данных от пользователя.
# print() используется для вывода информации и результатов операций.
# Работа с файлами:
...
# Функции save_data() и load_data() используют контекстный менеджер with для корректной работы с файлами.
...
# В функции load_data() используется ключевое слово global для изменения глобальной переменной countries.
...
# Структура данных:
# Страны и столицы хранятся в словаре, где ключ - название страны, значение - название столицы.
...
#         """
#         Инициализация объекта класса Number.
...
#     """Вывод меню на экран."""
#     print("\nМеню:")
#     print("1. Получить значение числа")
#     print("2. Установить значение числа")
#     print("3. Перевести в восьмеричную систему")
#     print("4. Перевести в шестнадцатеричную систему")
#     print("5. Перевести в двоичную систему")
#     print("6. Выход")
...
#         if choice == '1':
#             print(f"Текущее значение: {number.get_value()}")
#         elif choice == '2':
#             try:
...
#                 print(f"Ошибка: {e}")
#         elif choice == '3':
#             print(f"Восьмеричное представление: {number.to_octal()}")
#         elif choice == '4':
...
# Класс Number:
# Инициализируется с начальным значением, которое по умолчанию равно 0.
# Методы get_value и set_value позволяют получать и устанавливать значение числа соответственно.
# Методы to_octal, to_hex и to_binary переводят число в соответствующие системы счисления.
...
# Меню взаимодействия:
# Выводится на экран с помощью функции print_menu.
# Пользователь может выбрать действие, введя соответствующее число.
...
# Модульные тесты:
# Проверяют правильность работы методов класса Number.
# Тестируются различные сценарии, включая установку и получение значения, 
# перевод в разные системы счисления и обработку ошибок.
